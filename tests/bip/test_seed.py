...
class TestSeed(TestCase):
    ...
    def _assert_return(self, path: str, ref_public_key: str, ref_chaincode: str, curve: CurveChoice):
    ...
    def test_get_public_key_and_chaincode_secp256k1(self):
        ...
        for (path, ref_public_key, ref_chaincode) in secp256k1_test_values:
            self._assert_return(path, ref_public_key, ref_chaincode, CurveChoice.Secp256k1)
    ...
    def test_get_public_key_and_chaincode_nist256p1(self):
        ...
        for (path, ref_public_key, ref_chaincode) in nist256p1_test_values:
            self._assert_return(path, ref_public_key, ref_chaincode, CurveChoice.Nist256p1)
    ...
    def test_get_public_key_and_chaincode_ed25519slip(self):
        ...
        for (path, ref_public_key, ref_chaincode) in ed25519slip_test_values:
            self._assert_return(path, ref_public_key, ref_chaincode, CurveChoice.Ed25519Slip)
    ...
    def test_get_public_key_and_chaincode_ed25519kholaw(self):
        ...
        for (path, ref_public_key, ref_chaincode) in ed25519kholaw_test_values:
            self._assert_return(path, ref_public_key, ref_chaincode, CurveChoice.Ed25519Kholaw)
    ...
    def test_get_public_key_and_chaincode_ed25519blake2bslip(self):
        ...
        for (path, ref_public_key, ref_chaincode) in ed25519blake2bslip_test_values:
            self._assert_return(path, ref_public_key, ref_chaincode, CurveChoice.Ed25519Blake2bSlip)
