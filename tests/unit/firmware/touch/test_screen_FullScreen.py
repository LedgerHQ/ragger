...
class TestFullScreen(TestCase):
    ...
    def test_non_variable_layouts(self):
        ...
        layout_positions = [
            ...
            (
                self.screen.tappable_center,
                POSITIONS["TappableCenter"][self.device.type],
            ),
            (
                self.screen.centered_footer,
                POSITIONS["CenteredFooter"][self.device.type],
            ),
    ...
    def test_keyboards_common_functions(self):
        layouts_word_positions = [
            (
                self.screen.letter_only_keyboard,
                "basicword",
                POSITIONS["LetterOnlyKeyboard"][self.device.type],
            ),
            (
                self.screen.full_keyboard_letters,
                "still basic",
    ...
    def test_keyboards_change_case(self):
        ...
        self.assertEqual(
            self.backend.finger_touch.call_args,
