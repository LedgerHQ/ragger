...
class FatstacksNavigator(Navigator):
    ...
    def __init__(self, backend: BackendInterface, firmware: Firmware, golden_run: bool = False):
        ...
        callbacks = {
            ...
            NavInsID.USE_CASE_SETTINGS_EXIT: screen.settings.exit,
            NavInsID.USE_CASE_SETTINGS_BACK: screen.settings.back,
            ...
            NavInsID.USE_CASE_REVIEW_BACK: screen.review.back,
            ...
            NavInsID.USE_CASE_VIEW_DETAILS_BACK: screen.view_details.back,
            NavInsID.USE_CASE_VIEW_DETAILS_NEXT: screen.view_details.next,
            NavInsID.USE_CASE_ADDRESS_CONFIRMATION_SHOW_QR: screen.address_confirmation.show_qr,
